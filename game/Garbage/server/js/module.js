...
// CARD CLASS
exports.card = function (gemColor, points, cRed, cBlue, cBrown, cGreen, cWhite) {
...
//NOBLE CLASS
/*exports.noble = function (cRed, cBlue, cBrown, cGreen, cWhite) {
 this.cost = [cRed, cBlue, cBrown, cGreen, cWhite ]
 this.points = 3
 };*/
...
//                                      num of players. it's equal to # of players + 1
    ...
    // static data currently. Not sure how to pull data from users
    addPlayer(this.player, "Cody");
    addPlayer(this.player, "Nichols");
    addPlayer(this.player, "Andrew");
    addPlayer(this.player, "Kristin");
...
var addPlayer = function (playerList, playerName) {
    playerList.push(new player(playerName));
};
